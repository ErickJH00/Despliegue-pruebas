...
# ===========================================================
# Dashboard vigilante API (resumen)
...
# ===========================================================
# Alertas, eventos y vigilante
@app.route("/api/admin/alertas", methods=["GET"])
@token_requerido
def get_alertas():
    try:
        alertas = obtener_alertas_controller()  # Corrección: llamar a tu controlador real
